...
TEXT_ENGINE_ARGS = AsyncEngineArgs(
    model="/data3/ckpt/Qwen/Qwen2.5-1.5B-Instruct",
    enforce_eager=True,
...
async def test_vllm_async_llm():
    engine_args,prompt = TEXT_ENGINE_ARGS, TEXT_PROMPT
    engine = AsyncLLM.from_engine_args(engine_args)
...
if __name__ == "__main__":
    # import asyncio
    asyncio.run(test_vllm_async_llm())
