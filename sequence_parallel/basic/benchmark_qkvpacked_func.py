...
if __name__ == "__main__":
    ...
    if rank == 0:
        print(f"{flash_attn_qkvpacked_func.__name__} BS:{args.batch_size} seq_len:{args.seq_len} nheads:{args.nheads} head_size:{args.head_size}, fwd_only: {args.fwd_only}")
    benchmark(flash_attn_qkvpacked_func, forward_only=args.fwd_only, log=True, profile=args.profile)
